...
export class MatchingService {
     ...
     */
    async matchTalentToJob(talent, job, complexity) {
        let matchScore = 0;
        const reasons = [];
        ...
        const stackMatches = complexity.technicalStack.filter(skill => talentBadges.some(badge => badge.includes(skill.toLowerCase())));
