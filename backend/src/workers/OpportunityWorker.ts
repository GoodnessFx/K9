...
export class OpportunityWorker {
  private sniffer: SourceSniffer;
  private filter: FilterService;
  private matching: MatchingService;
  private vetting: VettingService;
  
  private snifferWorker: Worker;
  private verifyWorker: Worker;
   ...
   */
  async processSniffJob(url: string) {
  ...
  async enqueueVerify(type: 'company' | 'talent', data: any) {
  ...
  async enqueueNotify(channel: 'whatsapp' | 'telegram', recipient: string, message: string) {
