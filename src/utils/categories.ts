export const CATEGORY_CONFIG: Record<string, { 
  ...
  airdrop:     { label: 'Free Money',   color: '#00C87A', bgColor: '#0a2e1e' }, 
  bounty:      { label: 'Free Money',   color: '#00C87A', bgColor: '#0a2e1e' }, 
  learn:       { label: 'Free Money',   color: '#00C87A', bgColor: '#0a2e1e' }, 
  grant:       { label: 'Free Money',   color: '#00C87A', bgColor: '#0a2e1e' }, 
  job:         { label: 'Crypto Jobs',   color: '#3B82F6', bgColor: '#0a1a35' }, 
  ...
  security:    { label: 'Watch Out',               color: '#EF4444', bgColor: '#2e0a0a' }, 
